...
const Main = () => {
  return (
    <>
      <Carousel />
      <section id="about-area" className="bg-default">
        <div className="div-line"></div>
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="main-title"><span className="logo-text">Alvo<i
                className="fa-solid fa-location-crosshairs"></i>Concreto</span></h3>
            </div>
            ...
            <div className="col-md-6">
              <h3 className="about-title">Conheça a Alvo Concreto</h3>
              ...
              <p className="rm-mobile">Com uma sólida experiência, nossa missão é oferecer produtos e serviços que
                atendam às
